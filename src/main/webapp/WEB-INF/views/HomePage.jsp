...
<html>
<style>
#rightCrossId, #leftPanelId, #leftCrossId, #profileId, #circleId, #mailId, #leftInitial, #rightInitial, #websiteLinks, #lineIdLeftOne,
	#lineIdLeftTwo, #lineIdLeftThree,#lineIdLeftFour, #lineIdLeftFive, #lineIdRightOne, #lineIdRightTwo, #lineIdRightThree,#lineIdRightFour, #lineIdRightFive, #githubId, #linkedInId, #skillSetBoxId, #boxOneId, #boxTwoId, #boxThreeId,
	#boxFourId, #boxFiveId, #boxSixId, #boxSevenId, #extensionBox, #labelDiv, #percentageDiv, #labelOne, #labelTwo, #labelThree, #labelFour, 
	#labelFive, #statusOne, #statusTwo, #statusThree, #statusFour, #statusFive, #empSummary, #academicSummary, #projectNameId, #projectNameLabel,
	#projectNamePara, #projectDespLabel, #projectDespPara, #companyNameLabel, #companyNamePara, #teamSizeLabel, #teamSizePara, #profileLabel,
	#profilePara {
	position: absolute;
}
...
<body>
	<div id="leftPanelId">
		...
		<label for="professionalLabel">${professional}</label> 
		<label for="experienceLabel">${experience}</label>
		<label for="employmentLabel">${employment}</label>
		<label for="academicLabel">${academic}</label>
	...
	<div id="profileId">
		...
		<div id="extensionBox">
		  <div id="labelDiv">
		   <label id="labelOne"></label>
		   <label id="labelTwo"></label>
		   <label id="labelThree"></label>
		   <label id="labelFour"></label>
		   <label id="labelFive"></label>
		  </div>
		...
		<div id="empSummary">
		   <p align="left" style="font-family: 'sans-serif'; position: absolute;  width:54em; left: 330px; font-size: 17px; font-style: italic;">${employmentSummaryOne}</p>
		   <p align="left" style="font-family: 'sans-serif'; position: absolute;  width:48em; top: 34px; left: 330px; font-size: 17px; font-style: italic;">${employmentSummaryTwo}</p>
		</div>
		<div id="academicSummary">
		   <p align="left" style="font-family: 'sans-serif'; position: absolute;  width:67em; left: 330px; font-size: 17px; font-style: italic;">${academicSummary}</p>
		</div>
		<div id="projectNameId">
		  <label id="companyNameLabel">${companyNameLabel}</label>
		  <label id="projectNameLabel">${projectNameLabel}</label>
		  <label id="projectDespLabel">${projectDespLabel}</label>
		  <label id="teamSizeLabel">${teamSizeLabel}</label>
		  <label id="profileLabel">${profileLabel}</label>
