...
#labelOne, #labelTwo, #labelThree, #labelFour, #labelFive, #statusOne,
	#statusTwo, #statusThree, #statusFour, #statusFive {
	display: none;
}
...
#projectNameLabel, #projectNamePara, #projectDespLabel, #projectDespPara,
	#companyNameLabel, #companyNamePara, #teamSizeLabel, #teamSizePara,
	#profileLabel, #profilePara {
	font-size: 17px;
	font-style: italic;
}
		...
		$
				.ajax({
					...
					success : function(result) {
						var labelDivVar = document.getElementById("labelDiv");
						var percentageDivVar = document
								.getElementById("percentageDiv");
						var labelOneVar = document.getElementById("labelOne");
						var labelTwoVar = document.getElementById("labelTwo");
						var labelThreeVar = document
								.getElementById("labelThree");
						...
						var statusThreeVar = document
								.getElementById("statusThree");
						var statusFourVar = document
								.getElementById("statusFour");
						var statusFiveVar = document
								.getElementById("statusFive");
						...
						if (result.skills.length == 1) {
							...
							statusOneVar.style.background = "linear-gradient(to right, rgba(255, 92, 92, 1)"
									+ result.percentage[0]
									+ ", rgba(255, 0, 0, 0))";
							...
							statusTwoVar.style.background = "linear-gradient(to right, rgba(255, 92, 92, 1)"
									+ result.percentage[1]
									+ ", rgba(255, 0, 0, 0))";
							...
							statusThreeVar.style.background = "linear-gradient(to right, rgba(255, 92, 92, 1)"
									+ result.percentage[2]
									+ ", rgba(255, 0, 0, 0))";
						} else {
							academicSummmary.style.display = "none";
							...
							statusFourVar.style.background = "linear-gradient(to right, rgba(255, 92, 92, 1)"
									+ result.percentage[3]
									+ ", rgba(255, 0, 0, 0))";
							...
							statusFiveVar.style.background = "linear-gradient(to right, rgba(255, 92, 92, 1)"
									+ result.percentage[4]
									+ ", rgba(255, 0, 0, 0))";
							labelOneVar.innerHTML = result.skills[0];
							labelTwoVar.innerHTML = result.skills[1];
